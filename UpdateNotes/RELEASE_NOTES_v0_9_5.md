...
Colours in screen shares and OBS: on NVIDIA, the Vibrance slider does show up for
people watching your stream. Saturation above 100% is applied on your own monitor but
is not picked up by capture software, and on AMD and Intel the effect stays local to
your screen for now. Getting stream-visible colour on AMD and Intel is what's being
worked on next.
